...
from .data import get_data_transforms, get_batch_input_key, CDSDDataset, NUM_LABELS
from .models import construct_models
from .losses import get_mixture_loss_function
from .utils import get_optimizer
from .logs import HistoryLogger
...
def train(root_data_dir, train_config, output_dir, num_data_workers=1, checkpoint_interval=10):
    ...
    separator, classifier = construct_models(train_config)
    ...
    history_logger = HistoryLogger(history_path)
